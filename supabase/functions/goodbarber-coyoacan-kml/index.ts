...
serve(async (req: Request) => {
  ...
  try {
    ...
    const CORREDOR_ID = '97493529-0625-44c7-a514-0b41cf612903'
...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    <name>Coyoacán - CDMX</name>
    <description>Todos los puntos de interés del corredor Coyoacán</description>
${placemarks}
  </Document>
</kml>`

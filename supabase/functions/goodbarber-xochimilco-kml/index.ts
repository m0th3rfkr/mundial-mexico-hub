...
serve(async (req: Request) => {
  ...
  try {
    ...
    const CORREDOR_ID = 'bc2c91a3-b564-4962-b74d-e13b6b7cb1b3'
    ...
    const kml = `<?xml version="1.0" encoding="UTF-8"?><kml xmlns="http://www.opengis.net/kml/2.2"><Document><name>Xochimilco - CDMX</name><description>Todos los puntos de interés del corredor Xochimilco</description>${placemarks}</Document></kml>`

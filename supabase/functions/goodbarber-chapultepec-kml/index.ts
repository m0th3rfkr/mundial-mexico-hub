...
serve(async (req: Request) => {
  ...
  try {
    ...
    const CORREDOR_ID = 'b90c50e9-027e-4394-ac13-57f29d4bc84f'
    ...
    const kml = `<?xml version="1.0" encoding="UTF-8"?><kml xmlns="http://www.opengis.net/kml/2.2"><Document><name>Chapultepec - CDMX</name><description>Todos los puntos de interés del corredor Chapultepec</description>${placemarks}</Document></kml>`

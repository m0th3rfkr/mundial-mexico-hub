...
serve(async (req: Request) => {
  ...
  try {
    ...
    const CORREDOR_ID = 'b1663b4b-466f-433f-9f8a-9ea2508ad032'
...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    <name>Basílica - CDMX</name>
    <description>Todos los puntos de interés del corredor Basílica</description>
${placemarks}
  </Document>
</kml>`
